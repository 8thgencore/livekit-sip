...
func TestClassifyInviteError(t *testing.T) {
	...
	cases := []struct {
		...
		{"403 Forbidden", sipStatusErr(403), callDropped, stats.ServerError("forbidden"), livekit.DisconnectReason_SIP_TRUNK_FAILURE, true},
		...
		{"487 Request Terminated", sipStatusErr(487), callRejected, stats.ClientError("request-terminated"), livekit.DisconnectReason_USER_REJECTED, false},

		// 5xx upstream server error
		{"500 Internal Server Error", sipStatusErr(500), callDropped, stats.ServerError("internal-server-error"), livekit.DisconnectReason_SIP_TRUNK_FAILURE, true},
		{"503 Service Unavailable", sipStatusErr(503), callDropped, stats.ServerError("service-unavailable"), livekit.DisconnectReason_SIP_TRUNK_FAILURE, true},
		...
		{"603 Global Decline", sipStatusErr(603), callRejected, stats.ClientError("declined"), livekit.DisconnectReason_USER_REJECTED, false},
